...
public class GameObject {
	...
	//Instance Variables
	//New Rule this assumes that x, y is the top right corner of the object -- FOR Everybody
	int xLoc, yLoc; 
	int objW; 
	int objH;
	double dx, dy;
	...
	public GameObject(String type, int w, int h) {
		...
		//NOW Following the Rule that this is the top right of the object
	...
	public void setNewBBox(int xFromXLoc, int yFromYLoc,int BBwidth,int BBheight){
		newBBoxX = xFromXLoc;
		newBBoxY = yFromYLoc;
		newBBoxW = BBwidth;
		newBBoxH = BBheight;
